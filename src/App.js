...
import { getRandomQuotesApi } from "./api/QuotesApi";
import Header from "./components/Header";
import SearchedQuotesByAuthor from "./components/SearchedQuotesByAuthor";
...
function App() {
  ...
  return (
    <div>
      ...
      {searchPressed ? (
        <SearchedQuotesByAuthor authorContent={authorContent} />
      ) : (
        <div>
